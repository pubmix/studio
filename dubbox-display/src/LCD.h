...
#define Arduino_SPI     1 //1:use SPI to drive
  ...
  #define layer2_start_addr 1843200     //720*1280*2
  #define layer3_start_addr 3686400     
  #define layer4_start_addr 5529600
  #define layer5_start_addr 7372800  
  #define layer6_start_addr 9216000   
  #define layer7_start_addr 11059200  
  #define layer8_start_addr 12902400
  #define layer9_start_addr 14745600
