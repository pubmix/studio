...
The separate engine implementation has not yet been imported or reconciled with this initial schema. Its adapter should explicitly translate its current output metadata into this transfer profile.
